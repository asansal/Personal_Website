    ...
    (function() {{
        ...
        if (!doc.getElementById('chatbot-injected-styles')) {{
            ...
            style.textContent = `
                ...
                .chatbot-popup {{
                    position: fixed; bottom: 250px; right: 50px; width: 500px; height: 700px;
                ...
                @media (max-width: 768px) {{
                    .chatbot-popup   {{ width: calc(100vw - 30px); height: calc(100vh - 140px); bottom: 115px; right: 15px; }}
                    .chatbot-trigger {{ bottom: 115px; right: 15px; width: 60px; height: 60px; }}
                }}
            `;
